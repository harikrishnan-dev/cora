...
from it_man.agents.warranty_service.prompts import WARRANTY_SERVICE_PROMPT
from it_man.agents.warranty_service.tools import make_warranty_service_tools
